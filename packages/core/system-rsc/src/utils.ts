...
/**
 * Checks if a component is a YooUI component.
 * @param component - The component to check.
 * @returns `true` if the component is a YooUI component, `false` otherwise.
 */
export const isYooUIEl = (component: React.ReactComponentElement<any>) => {
  return !!component.type?.render?.displayName?.includes("YooUI");
};
