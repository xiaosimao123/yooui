...
/**
 * The YooUI config.
 * @see https://YooUI.org/docs/customization/customize-theme
 */
export type YooUIPluginConfig = {
  /**
  ...
  prefix?: string;
  /**
   * If true, the common YooUI colors (e.g. "blue", "green", "purple") will not be extended on the theme.
   * @default false
   */
