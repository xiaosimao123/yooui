import type {BreadcrumbsVariantProps, SlotsToClasses, BreadcrumbsSlots} from "@simao234430/theme";
...
import {breadcrumbs} from "@simao234430/theme";
import {filterDOMProps, pickChildren, ReactRef, useDOMRef} from "@simao234430/react-utils";
...
interface Props extends HTMLYooUIProps<"nav">, AriaBreadcrumbsProps {
  /**
   * Ref to the DOM node.
   */
