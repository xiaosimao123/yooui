...
import {useAriaMenu} from "@simao234430/use-aria-menu";
import {menu, MenuVariantProps, SlotsToClasses, MenuSlots} from "@simao234430/theme";
...
export type UseMenuProps<T = object> = Props<T> &
  Omit<HTMLYooUIProps<"ul">, keyof AriaMenuProps<T>> &
  AriaMenuProps<T> &
  MenuVariantProps;
