...
import {menuItem} from "@simao234430/theme";
import {HTMLYooUIProps, mapPropsVariants, PropGetter} from "@simao234430/system";
import {useFocusRing} from "@react-aria/focus";
import {TreeState} from "@react-stately/tree";
import {clsx, dataAttr, objectToDeps, removeEvents} from "@simao234430/shared-utils";
import {useAriaMenuItem} from "@simao234430/use-aria-menu";
import {mergeProps} from "@react-aria/utils";
import {useIsMobile} from "@simao234430/use-is-mobile";
import {filterDOMProps} from "@simao234430/react-utils";
...
export type UseMenuItemProps<T extends object> = Props<T> &
  Omit<HTMLYooUIProps<"li">, keyof Props<T>>;
