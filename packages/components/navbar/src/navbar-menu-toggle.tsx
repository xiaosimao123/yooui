import {AriaToggleButtonProps, useAriaToggleButton} from "@simao234430/use-aria-toggle-button";
...
export interface Props extends Omit<HTMLYooUIProps<"button">, keyof AriaToggleButtonProps> {
  /**
...
NavbarMenuToggle.displayName = "YooUI.NavbarMenuToggle";
