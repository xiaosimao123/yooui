import type {ImageVariantProps, SlotsToClasses, ImageSlots} from "@simao234430/theme";
...
import {useImage as useImageBase} from "@simao234430/use-image";
import {useMemo} from "react";
type NativeImageProps = ImgHTMLAttributes<HTMLImageElement>;

interface Props extends HTMLYooUIProps<"img"> {
  /**
   * Ref to the DOM node.
   */
