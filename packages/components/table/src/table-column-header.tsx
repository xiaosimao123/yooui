...
import {ChevronDownIcon} from "@simao234430/shared-icons";
...
// @internal
export interface TableColumnHeaderProps<T = object> extends HTMLYooUIProps<"th"> {
...
TableColumnHeader.displayName = "YooUI.TableColumnHeader";
