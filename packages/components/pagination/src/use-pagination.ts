import type {PaginationSlots, PaginationVariantProps, SlotsToClasses} from "@simao234430/theme";
import type {Key, ReactNode, Ref} from "react";
import type {HTMLYooUIProps, PropGetter} from "@simao234430/system";

import {objectToDeps, Timer} from "@simao234430/shared-utils";
import {useLocale} from "@react-aria/i18n";
import {
  UsePaginationProps as UseBasePaginationProps,
  PaginationItemValue,
  PaginationItemType,
} from "@simao234430/use-pagination";
import {useEffect, useRef, useMemo} from "react";
import {mapPropsVariants} from "@simao234430/system";
import {usePagination as useBasePagination} from "@simao234430/use-pagination";
...
interface Props extends Omit<HTMLYooUIProps<"nav">, "onChange"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;
