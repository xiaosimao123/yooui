import {PaginationItemValue} from "@simao234430/use-pagination";
import {useCallback} from "react";
import {useLocale} from "@react-aria/i18n";
import {forwardRef} from "@simao234430/system";
import {PaginationItemType} from "@simao234430/use-pagination";
import {ChevronIcon, EllipsisIcon, ForwardIcon} from "@simao234430/shared-icons";
...
const Pagination = forwardRef<"nav", PaginationProps>((props, ref) => {
  ...
  const renderItem = useCallback(
    (value: PaginationItemValue, index: number) => {
      ...
      return (
        <PaginationItem   key={value} getAriaLabel={getItemAriaLabel}>
          {value}
        </PaginationItem>
      );
    },
...
Pagination.displayName = "YooUI.Pagination";
