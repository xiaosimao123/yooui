...
import {listbox, ListboxVariantProps, ListboxSlots, SlotsToClasses} from "@simao234430/theme";
import {ListState, useListState} from "@react-stately/list";
import {filterDOMProps, ReactRef, useDOMRef} from "@simao234430/react-utils";
...
interface Props<T> extends Omit<HTMLYooUIProps<"ul">, "children"> {
  /**
   * Ref to the DOM node.
   */
