import type {TabsVariantProps, SlotsToClasses, TabsSlots, TabsReturnType} from "@simao234430/theme";
...
import {CollectionProps} from "@simao234430/aria-utils";
import {CollectionChildren} from "@react-types/shared";
import {HTMLMotionProps} from "framer-motion";

export interface Props extends Omit<HTMLYooUIProps, "children"> {
  /**
   * Ref to the DOM node.
   */
