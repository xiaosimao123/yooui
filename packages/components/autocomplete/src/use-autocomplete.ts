import type {AutocompleteVariantProps, SlotsToClasses, AutocompleteSlots} from "@simao234430/theme";

import {DOMAttributes, HTMLYooUIProps, mapPropsVariants, PropGetter} from "@simao234430/system";
import {useSafeLayoutEffect} from "@simao234430/use-safe-layout-effect";
...
import {PopoverProps} from "@simao234430/popover";
import {ListboxProps} from "@simao234430/listbox";
import {InputProps} from "@simao234430/input";
import {clsx, dataAttr, objectToDeps} from "@simao234430/shared-utils";
import {ScrollShadowProps} from "@simao234430/scroll-shadow";
import {chain, mergeProps} from "@react-aria/utils";
import {ButtonProps} from "@simao234430/button";
import {AsyncLoadable, PressEvent} from "@react-types/shared";
import {useComboBox} from "@react-aria/combobox";

interface Props<T> extends Omit<HTMLYooUIProps<"input">, keyof ComboBoxProps<T>> {
  /**
   * Ref to the DOM node.
   */
