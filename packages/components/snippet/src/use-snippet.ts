import type {SnippetVariantProps, SnippetSlots, SlotsToClasses} from "@simao234430/theme";
...
import {TooltipProps} from "@simao234430/tooltip";
import {ButtonProps} from "@simao234430/button";
export interface UseSnippetProps extends Omit<HTMLYooUIProps, "onCopy">, SnippetVariantProps {
  /**
   * Ref to the DOM node.
   */
  ...
  /**
   * Tooltip props.
   * @see [Tooltip](https://YooUI.org/components/tooltip) for more details.
   * @default {
   *  offset: 15,
   *  delay: 1000,
  ...
  /**
   * Copy button props.
   * @see [Button](https://YooUI.org/components/button) for more details.
   * @default {
   *   isDisabled: disableCopy,
   *   onPress: onCopy
   *   size:"sm",
