import type {DateInputVariantProps, DateInputSlots, SlotsToClasses} from "@simao234430/theme";
...
import {PropGetter, useProviderContext} from "@simao234430/system";
...
import {objectToDeps, clsx, dataAttr} from "@simao234430/shared-utils";
import {dateInput} from "@simao234430/theme";
...
interface Props<T extends DateValue> extends YooUIBaseProps<T> {
  /**
   * Ref to the DOM node.
   */
