...
import {accordionItem} from "@simao234430/theme";
import {clsx, callAllHandlers, dataAttr, objectToDeps} from "@simao234430/shared-utils";
import {ReactRef, useDOMRef, filterDOMProps} from "@simao234430/react-utils";
import {NodeWithProps} from "@simao234430/aria-utils";
import {useReactAriaAccordionItem} from "@simao234430/use-aria-accordion";
...
export interface Props<T extends object> extends HTMLYooUIProps<"div"> {
  /**
   * Ref to the DOM node.
   */
