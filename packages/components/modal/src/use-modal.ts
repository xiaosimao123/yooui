import type {ModalVariantProps, SlotsToClasses, ModalSlots} from "@simao234430/theme";
import type {HTMLMotionProps} from "framer-motion";

import {AriaModalOverlayProps} from "@react-aria/overlays";
import {useAriaModalOverlay} from "@simao234430/use-aria-modal-overlay";
...
interface Props extends HTMLYooUIProps<"section"> {
  /**
   * Ref to the DOM node.
   */
