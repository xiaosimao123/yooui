...
import {TRANSITION_VARIANTS} from "@simao234430/framer-utils";
import {CloseIcon} from "@simao234430/shared-icons";
...
export interface ModalContentProps extends AriaDialogProps, HTMLYooUIProps<"div", KeysToOmit> {
...
ModalContent.displayName = "YooUI.ModalContent";
