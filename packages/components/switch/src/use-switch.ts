import type {ToggleVariantProps, ToggleSlots, SlotsToClasses} from "@simao234430/theme";
...
import {toggle} from "@simao234430/theme";
...
interface Props extends HTMLYooUIProps<"input"> {
  /**
   * Ref to the DOM node.
   */
