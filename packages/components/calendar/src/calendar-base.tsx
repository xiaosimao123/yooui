...
import type {As, HTMLYooUIProps} from "@simao234430/system";
...
import {ResizablePanel} from "@simao234430/framer-utils";
...
export interface CalendarBaseProps extends HTMLYooUIProps<"div"> {
  Component?: As;
  showHelper?: boolean;
