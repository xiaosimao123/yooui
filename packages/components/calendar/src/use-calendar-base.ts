import type {CalendarReturnType, CalendarVariantProps} from "@simao234430/theme";
import type {CalendarPropsBase as AriaCalendarPropsBase} from "@react-types/calendar";
import type {CalendarSlots, SlotsToClasses} from "@simao234430/theme";
...
import type {SupportedCalendars} from "@simao234430/system";
import type {CalendarState, RangeCalendarState} from "@react-stately/calendar";
import type {RefObject, ReactNode} from "react";

import {Calendar, CalendarDate} from "@internationalized/date";
import {mapPropsVariants} from "@simao234430/system";
import {useCallback, useMemo} from "react";
import {calendar} from "@simao234430/theme";
import {useControlledState} from "@react-stately/utils";
import {ReactRef, useDOMRef} from "@simao234430/react-utils";
import {useLocale} from "@react-aria/i18n";
import {clamp, dataAttr, objectToDeps} from "@simao234430/shared-utils";
import {mergeProps} from "@react-aria/utils";
import {useProviderContext} from "@simao234430/system";

type YooUIBaseProps = Omit<HTMLYooUIProps<"div">, keyof AriaCalendarPropsBase | "onChange">;

interface Props extends YooUIBaseProps {
  /**
   * Ref to the DOM node.
   */
