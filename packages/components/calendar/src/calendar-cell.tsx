...
import type {CalendarSlots, SlotsToClasses, CalendarReturnType} from "@simao234430/theme";
...
export interface CalendarCellProps extends HTMLYooUIProps<"td">, AriaCalendarCellProps {
