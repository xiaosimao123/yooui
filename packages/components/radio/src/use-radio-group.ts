...
import type {RadioGroupSlots, SlotsToClasses} from "@simao234430/theme";

import {radioGroup} from "@simao234430/theme";
...
interface Props extends Omit<HTMLYooUIProps<"div">, "onChange"> {
  /**
   * Ref to the DOM node.
   */
