...
import type {RadioVariantProps, RadioSlots, SlotsToClasses} from "@simao234430/theme";
...
import {__DEV__, warn, clsx, dataAttr} from "@simao234430/shared-utils";
import {useDOMRef} from "@simao234430/react-utils";
import {chain, mergeProps} from "@react-aria/utils";

import {useRadioGroupContext} from "./radio-group-context";

interface Props extends Omit<HTMLYooUIProps<"input">, keyof RadioVariantProps> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;
