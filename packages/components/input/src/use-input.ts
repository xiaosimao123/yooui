import type {InputVariantProps, SlotsToClasses, InputSlots} from "@simao234430/theme";
...
import {clsx, dataAttr, isEmpty, objectToDeps, safeAriaLabel} from "@simao234430/shared-utils";
...
export interface Props<T extends HTMLInputElement | HTMLTextAreaElement = HTMLInputElement>
  extends Omit<HTMLYooUIProps<"input">, keyof InputVariantProps> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<T>;
