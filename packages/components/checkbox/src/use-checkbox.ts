import type {CheckboxVariantProps, CheckboxSlots, SlotsToClasses} from "@simao234430/theme";
...
import {useCallbackRef} from "@simao234430/use-callback-ref";
import {useHover, usePress} from "@react-aria/interactions";
import {useFocusRing} from "@react-aria/focus";
import {mergeProps, chain} from "@react-aria/utils";
import {__DEV__, warn, clsx, dataAttr, safeAriaLabel} from "@simao234430/shared-utils";
import {
...
import {mergeRefs} from "@simao234430/react-utils";
...
interface Props extends Omit<HTMLYooUIProps<"input">, keyof CheckboxVariantProps> {
  /**
   * Ref to the DOM node.
   */
