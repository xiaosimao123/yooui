...
import {dataFocusVisibleClasses} from "@simao234430/theme";
import {ChevronDownIcon, LinkIcon} from "@simao234430/shared-icons";
...
export const Navbar: FC<NavbarProps> = ({children, routes, mobileRoutes = [], slug, tag}) => {
  ...
  const handleVersionChange = (key: Key) => {
    if (key === "v1") {
      const newWindow = window.open("https://v1.YooUI.org", "_blank", "noopener,noreferrer");
