...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/badge",
    yarn: "yarn add @simao234430/badge",
    pnpm: "pnpm add @simao234430/badge",
    bun: "bun add @simao234430/badge"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Badge} from "@simao234430/react";',
    individual: 'import {Badge} from "@simao234430/badge";',
  }}
/>
