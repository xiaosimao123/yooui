...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/input",
    yarn: "yarn add @simao234430/input",
    pnpm: "pnpm add @simao234430/input",
    bun: "bun add @simao234430/input"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Textarea} from "@simao234430/react";',
    individual: 'import {Textarea} from "@simao234430/input";',
  }}
/>
