...
<PackageManagers
  commands={{
    cli: "nextui add spacer",
    npm: "npm install @simao234430/spacer",
    yarn: "yarn add @simao234430/spacer",
    pnpm: "pnpm add @simao234430/spacer",
    bun: "bun add @simao234430/spacer"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spacer} from "@simao234430/react";',
    individual: 'import {Spacer} from "@simao234430/spacer";',
  }}
/>
