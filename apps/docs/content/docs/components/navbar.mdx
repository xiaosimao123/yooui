...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/navbar",
    yarn: "yarn add @simao234430/navbar",
    pnpm: "pnpm add @simao234430/navbar",
    bun: "bun add @simao234430/navbar"
  }}
/>
