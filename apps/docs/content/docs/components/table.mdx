...
<PackageManagers
  commands={{
    cli: "nextui add table",
    npm: "npm install @simao234430/table",
    yarn: "yarn add @simao234430/table",
    pnpm: "pnpm add @simao234430/table",
    bun: "bun add @simao234430/table"
  }}
/>
...
```jsx
import {Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, getKeyValue} from "@simao234430/react";
...
[@simao234430/use-infinite-scroll](https://www.npmjs.com/package/@simao234430/use-infinite-scroll) hook.
