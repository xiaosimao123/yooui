...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/popover",
    yarn: "yarn add @simao234430/popover",
    pnpm: "pnpm add @simao234430/popover",
    bun: "bun add @simao234430/popover"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Popover, PopoverTrigger, PopoverContent} from "@simao234430/react";',
    individual: 'import {Popover, PopoverTrigger, PopoverContent} from "@simao234430/popover";',
  }}
/>
