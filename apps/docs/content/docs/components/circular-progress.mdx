...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/progress",
    yarn: "yarn add @simao234430/progress",
    pnpm: "pnpm add @simao234430/progress",
    bun: "bun add @simao234430/progress"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CircularProgress} from "@simao234430/react";',
    individual: 'import {CircularProgress} from "@simao234430/progress";',
  }}
/>
