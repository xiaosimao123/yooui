...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/scroll-shadow",
    yarn: "yarn add @simao234430/scroll-shadow",
    pnpm: "pnpm add @simao234430/scroll-shadow",
    bun: "bun add @simao234430/scroll-shadow"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {ScrollShadow} from "@simao234430/react";',
    individual: 'import {ScrollShadow} from "@simao234430/scroll-shadow";',
  }}
/>
