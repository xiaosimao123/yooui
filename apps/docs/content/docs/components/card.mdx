...
<PackageManagers
  commands={{
    cli: "nextui add card",
    npm: "npm install @simao234430/card",
    yarn: "yarn add @simao234430/card",
    pnpm: "pnpm add @simao234430/card",
    bun: "bun add @simao234430/card"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Card, CardHeader, CardBody, CardFooter} from "@simao234430/react";',
    individual: 'import {Card, CardHeader, CardBody, CardFooter} from "@simao234430/card";',
  }}
/>
