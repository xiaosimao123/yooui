...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/calendar",
    yarn: "yarn add @simao234430/calendar",
    pnpm: "pnpm add @simao234430/calendar",
    bun: "bun add @simao234430/calendar",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RangeCalendar} from "@simao234430/react";',
    individual: 'import {RangeCalendar} from "@simao234430/calendar";',
  }}
/>
...
| createCalendar            | `(calendar: SupportedCalendars) => Calendar \| null`                                                                                                                                                                                                                                                                                                                                          | This function helps to reduce the bundle size by providing a custom calendar system. You can also use the YooUIProvider to provide the createCalendar function to all nested components. | `all<br> calendars`               |     |
