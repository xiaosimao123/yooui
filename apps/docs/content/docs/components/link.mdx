...
<PackageManagers
  commands={{
    cli: "nextui add link",
    npm: "npm install @simao234430/link",
    yarn: "yarn add @simao234430/link",
    pnpm: "pnpm add @simao234430/link",
    bun: "bun add @simao234430/link"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Link} from "@simao234430/react";',
    individual: 'import {Link} from "@simao234430/link";',
  }}
/>
