...
<PackageManagers
  commands={{
    cli: "nextui add tooltip",
    npm: "npm install @simao234430/tooltip",
    yarn: "yarn add @simao234430/tooltip",
    pnpm: "pnpm add @simao234430/tooltip",
    bun: "bun add @simao234430/tooltip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tooltip} from "@simao234430/react";',
    individual: 'import {Tooltip} from "@simao234430/tooltip";',
  }}
/>
