...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/image",
    yarn: "yarn add @simao234430/image",
    pnpm: "pnpm add @simao234430/image",
    bun: "bun add @simao234430/image"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Image} from "@simao234430/react";',
    individual: 'import {Image} from "@simao234430/image";',
  }}
/>
