...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/breadcrumbs",
    yarn: "yarn add @simao234430/breadcrumbs",
    pnpm: "pnpm add @simao234430/breadcrumbs",
    bun: "bun add @simao234430/breadcrumbs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Breadcrumbs, BreadcrumbItem} from "@simao234430/react";',
    individual: 'import {Breadcrumbs, BreadcrumbItem} from "@simao234430/breadcrumbs";',
  }}
/>
