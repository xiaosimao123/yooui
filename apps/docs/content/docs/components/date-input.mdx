...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/date-input",
    yarn: "yarn add @simao234430/date-input",
    pnpm: "pnpm add @simao234430/date-input",
    bun: "bun add @simao234430/date-input",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateInput} from "@simao234430/react";',
    individual: 'import {DateInput} from "@simao234430/date-input";',
  }}
/>
