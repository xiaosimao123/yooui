...
<PackageManagers
  commands={{
    cli: "nextui add spinner",
    npm: "npm install @simao234430/spinner",
    yarn: "yarn add @simao234430/spinner",
    pnpm: "pnpm add @simao234430/spinner",
    bun: "bun add @simao234430/spinner"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Spinner} from "@simao234430/react";',
    individual: 'import {Spinner} from "@simao234430/spinner";',
  }}
/>
