...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/date-picker",
    yarn: "yarn add @simao234430/date-picker",
    pnpm: "pnpm add @simao234430/date-picker",
    bun: "bun add @simao234430/date-picker",
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {DateRangePicker} from "@simao234430/react";',
    individual: 'import {DateRangePicker} from "@simao234430/date-picker";',
  }}
/>
