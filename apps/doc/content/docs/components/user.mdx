...
<PackageManagers
  commands={{
    cli: "nextui add user",
    npm: "npm install @simao234430/user",
    yarn: "yarn add @simao234430/user",
    pnpm: "pnpm add @simao234430/user",
    bun: "bun add @simao234430/user"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {User} from "@simao234430/react";',
    individual: 'import {User} from "@simao234430/user";',
  }}
/>
