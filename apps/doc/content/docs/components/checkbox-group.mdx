...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/checkbox",
    yarn: "yarn add @simao234430/checkbox",
    pnpm: "pnpm add @simao234430/checkbox",
    bun: "bun add @simao234430/checkbox"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {CheckboxGroup, Checkbox} from "@simao234430/react";',
    individual: 'import {CheckboxGroup, Checkbox} from "@simao234430/checkbox";',
  }}
/>
