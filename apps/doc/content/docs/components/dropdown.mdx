...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/dropdown",
    yarn: "yarn add @simao234430/dropdown",
    pnpm: "pnpm add @simao234430/dropdown",
    bun: "bun add @simao234430/dropdown"
  }}
/>
...
```jsx
import {Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, Button} from "@simao234430/react";
