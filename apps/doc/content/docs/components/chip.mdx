...
<PackageManagers
  commands={{
    cli: "nextui add chip",
    npm: "npm install @simao234430/chip",
    yarn: "yarn add @simao234430/chip",
    pnpm: "pnpm add @simao234430/chip",
    bun: "bun add @simao234430/chip"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Chip} from "@simao234430/react";',
    individual: 'import {Chip} from "@simao234430/chip";',
  }}
/>
