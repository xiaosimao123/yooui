...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/accordion",
    yarn: "yarn add @simao234430/accordion",
    pnpm: "pnpm add @simao234430/accordion",
    bun: "bun add @simao234430/accordion"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Accordion, AccordionItem} from "@simao234430/react";',
    individual: 'import {Accordion, AccordionItem} from "@simao234430/accordion";',
  }}
/>
