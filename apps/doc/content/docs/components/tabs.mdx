...
<PackageManagers
  commands={{
    cli: "nextui add tabs",
    npm: "npm install @simao234430/tabs",
    yarn: "yarn add @simao234430/tabs",
    pnpm: "pnpm add @simao234430/tabs",
    bun: "bun add @simao234430/tabs"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Tabs, Tab} from "@simao234430/react";',
    individual: 'import {Tabs, Tab} from "@simao234430/tabs";',
  }}
/>
