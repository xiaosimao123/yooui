...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/switch",
    yarn: "yarn add @simao234430/switch",
    pnpm: "pnpm add @simao234430/switch",
    bun: "bun add @simao234430/switch"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Switch} from "@simao234430/react";',
    individual: 'import {Switch} from "@simao234430/switch";',
  }}
/>
