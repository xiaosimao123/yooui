...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/avatar",
    yarn: "yarn add @simao234430/avatar",
    pnpm: "pnpm add @simao234430/avatar",
    bun: "bun add @simao234430/avatar"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Avatar, AvatarGroup, AvatarIcon} from "@simao234430/react";',
    individual: 'import {Avatar, AvatarGroup, AvatarIcon} from "@simao234430/avatar";',
  }}
/>
