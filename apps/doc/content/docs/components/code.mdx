...
<PackageManagers
  commands={{
    cli: "nextui add code",
    npm: "npm install @simao234430/code",
    yarn: "yarn add @simao234430/code",
    pnpm: "pnpm add @simao234430/code",
    bun: "bun add @simao234430/code"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Code} from "@simao234430/react";',
    individual: 'import {Code} from "@simao234430/code";',
  }}
/>
