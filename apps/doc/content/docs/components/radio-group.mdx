...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/radio",
    yarn: "yarn add @simao234430/radio",
    pnpm: "pnpm add @simao234430/radio",
    bun: "bun add @simao234430/radio"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {RadioGroup, Radio} from "@simao234430/react";',
    individual: 'import {RadioGroup, Radio} from "@simao234430/radio";',
  }}
/>
