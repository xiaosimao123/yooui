...
<PackageManagers
  commands={{
    cli: "nextui add snippet",
    npm: "npm install @simao234430/snippet",
    yarn: "yarn add @simao234430/snippet",
    pnpm: "pnpm add @simao234430/snippet",
    bun: "bun add @simao234430/snippet"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Snippet} from "@simao234430/react";',
    individual: 'import {Snippet} from "@simao234430/snippet";',
  }}
/>
