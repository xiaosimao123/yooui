...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/select",
    yarn: "yarn add @simao234430/select",
    pnpm: "pnpm add @simao234430/select",
    bun: "bun add @simao234430/select"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Select, SelectSection, SelectItem} from "@simao234430/react";',
    individual: 'import {Select, SelectSection, SelectItem} from "@simao234430/select";',
  }}
/>
...
<PackageManagers
  commands={{
    npm: "npm install @simao234430/use-infinite-scroll",
    yarn: "yarn add @simao234430/use-infinite-scroll",
    pnpm: "pnpm add @simao234430/use-infinite-scroll",
  }}
/>
