...
<PackageManagers
  commands={{
    ...
    npm: "npm install @simao234430/skeleton",
    yarn: "yarn add @simao234430/skeleton",
    pnpm: "pnpm add @simao234430/skeleton",
    bun: "bun add @simao234430/skeleton"
  }}
/>
...
<ImportTabs
  commands={{
    main: 'import {Skeleton} from "@simao234430/react";',
    individual: 'import {Skeleton} from "@simao234430/skeleton";',
  }}
/>
